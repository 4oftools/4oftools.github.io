...
const APP_ID = 'mnemora';

@Component({
  selector: 'app-mnemora',
  standalone: true,
  imports: [CommonModule, RouterLink, AppIconComponent],
  templateUrl: './mnemora.component.html',
  styleUrls: ['./mnemora.component.css', '../app-header-icons.css']
})
export class MnemoraComponent implements OnInit, OnDestroy {
  app: Tool | undefined;
