...
const APP_ID = 'presentation-generator';
...
@Component({
  ...
  styleUrls: ['./presentation-generator.component.css', '../app-header-icons.css']
})
export class PresentationGeneratorComponent implements OnInit, OnDestroy {
  app: Tool | undefined;
