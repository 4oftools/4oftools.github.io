...
export class LanguageService {
  ...
  translations: { [key: string]: { zh: string; en: string } } = {
    ...
    'nav.tutorials': { zh: '视频教程', en: 'Tutorials' },
    'tutorials.paper.subtitle': { zh: '纸质质感 · 专题视频', en: 'Paper texture · Topic videos' },
    'tutorials.page.description': {
    ...
    'apps.stat.total': { zh: '应用总数', en: 'Total apps' },
    'apps.stat.opensource': { zh: '开源项目', en: 'Open source' },
    'apps.stat.planning': { zh: '规划中', en: 'In planning' },
    'apps.section.catalog': { zh: '应用精选', en: 'Featured apps' },
    ...
    'app.openSource': { zh: '开源', en: 'Open Source' },
    'app.openSourceUrl': { zh: '开源地址', en: 'Source Code' },
    'app.website': { zh: '官网', en: 'Website' },
    'app.download': { zh: '下载', en: 'Download' },
    'app.downloadUrl': { zh: '下载地址', en: 'Download' },
    'app.status': { zh: '状态', en: 'Status' },
    'app.license': { zh: '协议', en: 'License' },
    'app.version': { zh: '版本', en: 'Version' },
    'app.openSourceStatus': { zh: '开源', en: 'Open Source' },
    'tool.back.to.list': { zh: '返回列表', en: 'Back to List' },
    
    // Chronos App
    'chronos.features.kanban': { zh: '看板与列表视图', en: 'Kanban & List Views' },
    'chronos.features.sprints': { zh: '迭代（Sprint）规划', en: 'Sprint Planning' },
    'chronos.features.workflows': { zh: '自定义工作流', en: 'Custom Workflows' },
    'chronos.features.permissions': { zh: '项目与权限管理', en: 'Project & Permission Management' },
    'chronos.features.analytics': { zh: '数据分析与报表', en: 'Analytics & Reports' },
    'chronos.features.api': { zh: 'RESTful API', en: 'RESTful API' },
    'chronos.changelog.v1': { zh: '正式发布版本：完整的看板、迭代和工作流功能', en: 'Official release: Complete kanban, sprint and workflow features' },
    'chronos.changelog.v09': { zh: 'Beta 版本：添加工作流配置和权限管理', en: 'Beta release: Added workflow configuration and permission management' },
    'chronos.changelog.v05': { zh: 'Alpha 版本：基础看板功能和迭代规划', en: 'Alpha release: Basic kanban and sprint planning' },
    'chronos.changelog.v01': { zh: '项目启动：初始架构设计', en: 'Project kickoff: Initial architecture design' },
    'chronos.tags.project': { zh: '项目管理', en: 'Project Management' },
    'chronos.tags.kanban': { zh: '看板', en: 'Kanban' },
    'chronos.tags.agile': { zh: '敏捷开发', en: 'Agile' },
    'chronos.tags.opensource': { zh: '开源', en: 'Open Source' },
    ...
    'keyboard.hint': { zh: '点击下方区域获得焦点后，按下任意键进行测试', en: 'Click the area below to focus, then press any key to test' },
    'keyboard.lastKey': { zh: '最后按键', en: 'Last Key' },
    'keyboard.keyCode': { zh: '键码', en: 'Key Code' },
    'keyboard.modifiers': { zh: '修饰键', en: 'Modifiers' },
    'keyboard.clear': { zh: '清空记录', en: 'Clear' },
    'keyboard.empty': { zh: '暂无按键记录', en: 'No key pressed yet' },
    'keyboard.recent': { zh: '最近按键', en: 'Recent Keys' },
    ...
    'severance.triple.social.avg': { zh: '三倍社平工资', en: 'Triple Social Average Salary' },
    'severance.contract.monthly.salary': { zh: '合同基本月薪', en: 'Contract Monthly Base Salary' },
    'severance.y.months': { zh: 'Y月数 (N+几个月)', en: 'Y Months (N+months)' },
    'severance.severance.pay': { zh: '总补偿 (N+Y)', en: 'Total Compensation (N+Y)' },
    'severance.n.amount': { zh: 'N的金额', en: 'N Amount' },
    'severance.n.detail': { zh: 'N计算', en: 'N Calculation' },
    'severance.y.amount': { zh: 'Y的金额', en: 'Y Amount' },
    'severance.y.detail': { zh: 'Y计算', en: 'Y Calculation' },
    'severance.calculation.details': { zh: '计算说明', en: 'Calculation Details' },
    'severance.legal.info': { zh: '法律依据', en: 'Legal Basis' },
    'severance.n.explanation': { zh: '关于N（经济补偿金）', en: 'About N (Economic Compensation)' },
    'severance.y.explanation': { zh: '关于Y（额外补偿）', en: 'About Y (Additional Compensation)' },
    'severance.info.1': { zh: 'N = 工作年限，每满1年支付1个月工资', en: 'N = years of service, 1 month salary per year' },
    'severance.info.2': { zh: '工作年限不满6个月的，按半年计算（N = 0.5）', en: 'Work period less than 6 months: counted as 0.5 year (N = 0.5)' },
    'severance.info.3': { zh: '工作年限6个月以上不满1年的，按1年计算（N = 1）', en: 'Work period 6 months to less than 1 year: counted as 1 year (N = 1)' },
    'severance.info.4': { zh: '如果去年平均月薪超过三倍社平，且2008年之后部分的N超过12，则2008年之后部分按12计算', en: 'If last year average monthly salary exceeds triple social average and after 2008 part N > 12, then after 2008 part N = 12' },
    'severance.info.5': { zh: '2008年（含）之前的工作年限部分，不适用薪资限制，按实际工作年限计算；2008年之后的部分，需要按照三倍社平的计算逻辑来计算', en: 'Work years before 2008 (inclusive) are not subject to salary cap, counted as actual work years; work years after 2008 need to follow triple social average calculation logic' },
    'severance.info.6': { zh: 'Y = 企业额外支付的月数，Y最少为0或1', en: 'Y = additional months paid by company, Y minimum is 0 or 1' },
    'severance.info.7': { zh: 'Y = 0：需要提前一个月通知员工', en: 'Y = 0: requires one month advance notice to employee' },
    'severance.info.8': { zh: 'Y = 1：可以立即解除劳动合同', en: 'Y = 1: can terminate contract immediately' },
    'severance.disclaimer': { zh: '注意：本计算器仅供参考，实际补偿金额可能因地区、公司政策等因素有所不同。建议咨询专业法律人士获取准确信息。', en: 'Note: This calculator is for reference only. Actual compensation may vary due to regional differences, company policies, and other factors. Please consult with a legal professional for accurate information.' },
    'severance.yuan': { zh: '元', en: 'Yuan' },
    'severance.years': { zh: '年', en: 'Years' },
    'severance.months': { zh: '个月', en: 'Months' },
    'severance.calculate': { zh: '计算', en: 'Calculate' },
    'severance.termination.type': { zh: '裁员类型', en: 'Termination Type' },
    'severance.economic.termination': { zh: '经济性裁员', en: 'Economic Termination' },
    'severance.illegal.termination': { zh: '违法裁员', en: 'Illegal Termination' },
    'severance.severance.pay.economic': { zh: '总补偿 (N+Y)', en: 'Total Compensation (N+Y)' },
    'severance.severance.pay.illegal': { zh: '总补偿 (2N+Y)', en: 'Total Compensation (2N+Y)' }
  };
